#%%
# code for id parser with country values
import csv
...
with open(output_fp, "w", newline="", encoding="utf-8-sig") as csvfile:
    ...
    for idregdocument in root.findall(".//ns:IDRegDocument", ns):
        ...
        if distinct_party is not None:
            ...
            issued_by_country_name = country_mapping.get(issued_by_country_id, "Unknown Country")  # Look up country name
            ...
            data = {
                ...
                "Issued_By": issued_by,
                "Issuing Country": issued_by_country_name,
